//src/app/api/events/[eventId]/packages/[packageId]/route.ts
 ...
 * plus any EventPackageItems referencing it.
 */
export async function DELETE(request: Request, { params }: RouteProps) {
  try {
    ...
    // 1. Remove any items referencing this event+package
    ...
    return NextResponse.json({ error: 'Failed to remove package from event' }, { status: 500 });
  }
}